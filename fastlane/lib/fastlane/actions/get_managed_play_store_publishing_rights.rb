module Fastlane
  module Actions
    class GetManagedPlayStorePublishingRightsAction < Action
      ...
      def self.details
        [
          'If you haven\'t done so before, start by following the first two steps of Google\'s ["Get started with custom app publishing"](https://developers.google.com/android/work/play/custom-app-api/get-started) -> ["Preliminary setup"](https://developers.google.com/android/work/play/custom-app-api/get-started#preliminary_setup) instructions:',
